...
from optimol.models.components.unicore.transformer_encoder_with_pair import TransformerEncoderWithPair

from optimol.models.components.unicore.transformer_encoder_layer import LayerNorm, init_bert_params
...
class DockingPoseV2Model(nn.Module):
    @staticmethod
    def add_args(parser):
